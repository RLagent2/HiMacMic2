...
# TODO: 把mixer变成modulelist，然后返回的值是qtot，第一维度是哪个batch，第二个维度是时间t，第三个是q值，把他们组成一个list返回,OK
# TODO: 如果每个head不一样的网络结构再想想是不是在这改，有些麻烦。NOT DONE
